...
/**
 * @brief CFunctionalCPD class
 * 
 */
class PNL_API CFunctionalCPD : public CCPD
{
public:
    static CFunctionalCPD* Create( const intVector& domainIn, CModelDomain* pMD );
    static CFunctionalCPD* Copy( const CFunctionalCPD* pGauCPD );
    static CFunctionalCPD* CreateUnitFunctionCPD( const intVector& domainIn,
            CModelDomain* pMD);
...
#ifdef PNL_OBSOLETE
    static CFunctionalCPD* Create( const int *domain, int nNodes,
            CModelDomain* pMD );
    static CFunctionalCPD* CreateUnitFunctionCPD( const int *domain, int nNodes,
            CModelDomain* pMD );
    ...
    {
        return CFunctionalCPD::m_TypeInfo;
    }
#endif
    
protected:
    CFunctionalCPD( const int *domain, int nNodes, CModelDomain* pMD );
    CFunctionalCPD( const CFunctionalCPD& GauCPD );
    CFunctionalCPD( const CFunctionalCPD* pGauCPD );
