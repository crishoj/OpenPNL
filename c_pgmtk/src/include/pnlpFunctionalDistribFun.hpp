/**
 * @file pnlpFunctionalDistribFun.hpp
 ...
 * 
 * See also: pnlpFunctionalDistribFun.cpp
 * 
 * TODO: Full conversion
 */

#ifndef __PNLPFUNCTIONALDISTRIBFUN_HPP__
#define __PNLPFUNCTIONALDISTRIBFUN_HPP__
...
{
public:
    static CFunctionalDistribFun* CreateInMomentForm(int isPotential,
            int NumberOfNodes,
            const CNodeType *const* NodeTypes,
            const float *dataMean,
            const float *dataCov,
            const float **dataWeight = NULL);
    static CFunctionalDistribFun* CreateInCanonicalForm(int NumberOfNodes,
            const CNodeType *const* NodeTypes,
            const float *dataH,
            const float *dataK, float g = 0.0f);
    static CFunctionalDistribFun* CreateDeltaDistribution(int NumberOfNodes,
            const CNodeType *const* nodeTypes,
            const float *dataMean, int isMoment = 1, int isPotential = 1);
    static CFunctionalDistribFun* CreateUnitFunctionDistribution( int NumberOfNodes,
...
protected:
    ...
    CFunctionalDistribFun( int isPotential, int NodeNumber,
            ...
            const float *dataCov,
            const float **dataWeight = NULL);
    CFunctionalDistribFun( int NumberOfNodes,
            const CNodeType *const* nodeTypes,
            const float *dataH,
            const float *dataK,
            float g = 0.0f);
...
inline float CFunctionalDistribFun::GetCoefficient( int isCanonical ) const
{
...
inline int CFunctionalDistribFun::GetCanonicalFormFlag() const
{
    return m_bCanonical;
}

inline int CFunctionalDistribFun::GetMomentFormFlag() const
{
    return m_bMoment;
}
...
#endif //__PNLPFUNCTIONALDISTRIBFUN_HPP__
